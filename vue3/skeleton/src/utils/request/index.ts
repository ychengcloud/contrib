...
import { CareworkerServiceApi } from '@/api/server'
import { AggServiceApi } from '@/api/agg'
...
const apiHost = request.getBaseUrl();
let basePath: string | undefined = apiHost === "" ? undefined : apiHost;

console.log("import.meta.env.DEV", import.meta.env.DEV);
if (import.meta.env.DEV) {
    const metaUrl = new URL(import.meta.url);
    basePath = metaUrl.origin;
}

const careworkerService = new CareworkerServiceApi(undefined, basePath, request.getAxiosInstance())
export const aggService = new AggServiceApi(undefined, basePath, request.getAxiosInstance())

export default careworkerService
